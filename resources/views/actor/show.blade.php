...
@section('content')
		...
		<div class="container mx-auto px-4 py-16 flex items-center flex-col md:flex-row">
			<div class="flex-none">
				...
				<ul class="flex items-center mt-4">
					@if($social['facebook'])
					<li>
						<a href="{{ $social['facebook'] }}" title="Facebook"  target="_blanck">
					...
					@if($social['instagram'])
					<li class="ml-6">
						<a href="{{ $social['instagram'] }}" title="Instagram"  target="_blanck">
					...
					@if($social['twitter'])
					<li class="ml-6">
						<a href="{{ $social['twitter'] }}" title="Twitter"  target="_blanck">
					...
					@if ($actor['homepage'])
						<li class="ml-6">
							<a href="{{ $actor['homepage'] }}" title="Website" target="_blanck">
	...
	<div class="credits border-b border-gray-800">
		<div class="container mx-auto px-4 py-16">
			<h2 class="uppercase tracking-wider text-orange-500 text-lg font-semibold">Credits</h2>
